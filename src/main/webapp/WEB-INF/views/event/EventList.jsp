...
<body>
				...
				<div class="section" style="padding-top: 25px;">
					<div class="section-body m2">
									...
									<form action="./EventList" id="frm">
										...
										<div class="item" >
											<div class="txt-field hs" style="width: 320px;">
												...
												<input value="0" type="text" class="text"
													name="search22" id="search22" style="display: none">
											</div>
										</div>
						...
						<div class=" eventboard-sorting">
							<ul>
								<li><button class="ing2 active rrr" title="0">진행중 이벤트(5)</button></li>
								<li><button class="winner2 rrr" title="1">선정자 발표</button></li>
								<li><button class="finished2 rrr" title="2">종료된 이벤트(6)</button></li>
							</ul>
						</div>
	...
	<script type="text/javascript">
		...
		function check() {
			let title = $("#search22").val();
	
			if(title==0) {
				$('#eventList').removeClass("ffff");
				$('#finishList').addClass("ffff");
				$('#winnerList').addClass("ffff");
				$('.finished2').removeClass("active");
				$('.winner2').removeClass("active");
				$('.ing2').addClass("active");
				$('#searchBX').css("display", "");
				start();
				...
				$('#eventList').addClass("ffff");
				$('#finishList').addClass("ffff");
				$('.ing2').removeClass("active");
				$('.finished2').removeClass("active");
				$('.winner2').addClass("active");
				$('#searchBX').css("display", "none");
				winner();
