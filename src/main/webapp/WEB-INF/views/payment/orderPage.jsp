				...
				<div class="contents-inner mypage">
					...
					<div class="section">
						<div class="section-header">
							<h2 class="h2">주문목록/배송조회</h2>
						</div>
						<div class="section-body">
							<form method="get" name="frmDateSearch">
								<fieldset>
									<legend>주문목록/배송조회 날짜 검색</legend>
									...
									<div class="date-check">
										...
										<div class="check-cal">
											<div class="cal-from">
												<input type="text" name="wDate[]" value="2021-12-06"
													id="picker2" class="js-datepicker"> <img
													class="icon-cal"
													src="/data/skin/front/howling/img/etc/icon-cal.png"
													alt="달력 아이콘">
											</div>
											<div class="divide">~</div>
											<div class="cal-to">
												<input type="text" name="wDate[]" value="2021-12-13"
													class="js-datepicker"> <img class="icon-cal"
													src="/data/skin/front/howling/img/etc/icon-cal.png"
													alt="달력 아이콘">
											</div>
										</div>
										<div class="submit-block">
											<button type="submit" class="skinbtn point2 cl-find">
												<em>조회 <img alt=""
													src="/data/skin/front/howling/img/etc/search.png"></em>
											</button>
										</div>
									</div>
								</fieldset>
